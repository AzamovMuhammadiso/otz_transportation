  ...
  const services = [
    {
      ...
      description:
        "Dedicated truck for your large shipments across the country.",
    },
    {
      icon: Package,
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
            <div className="max-w-3xl space-y-6 animate-fade-in">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Trusted logistics partner delivering excellence in freight
                transportation for over 14 years. Your cargo, our commitment.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                About OTZ Transportation
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We are a leading freight transportation company committed to
                delivering excellence through innovative logistics solutions and
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Reveal delay={0.1}>
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our fleet is maintained to the highest standards, and our
                    drivers are extensively trained for safe, secure
                    transportation.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.2}>
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    We understand time is money. Our 98% on-time delivery rate
                    speaks to our commitment to meeting your deadlines.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.3}>
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our experienced team provides 24/7 support to ensure your
                    logistics run smoothly from pickup to delivery.
                  </p>
                </div>
              </Reveal>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.map((service, index) => (
                <Reveal key={index} delay={0.1 * (index + 1)}>
                  <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border-2 border-gray-100 hover:border-blue-300 transition-all hover:shadow-lg group">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600">
                Working with the best in logistics
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Get a free quote today and experience the OTZ Transportation
              difference
            </p>
