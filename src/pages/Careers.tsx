...
import { DollarSign, Home, Shield, TrendingUp, Calendar, Heart, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      <section className="relative h-[400px] bg-gradient-to-br from-blue-900 to-blue-700 text-white">
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/6169005/pexels-photo-6169005.jpeg?auto=compress&cs=tinysrgb&w=1920')] bg-cover bg-center opacity-20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Join Our Team</h1>
            <p className="text-xl text-blue-100 leading-relaxed">
              Drive with OTZ Transportation and enjoy competitive pay, great benefits, and respect on the road
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Drive for OTZ?</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white p-10 rounded-2xl shadow-lg">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Driver Requirements</h2>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">
                  Thank you for your interest. Our recruitment team will review your application and contact you soon.
                </p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="cdl_type" className="block text-sm font-semibold text-gray-700 mb-2">
                  CDL Type *
                </label>
                <select
                  id="cdl_type"
              ...
              <div>
                <label htmlFor="current_employer" className="block text-sm font-semibold text-gray-700 mb-2">
            ...
            <div>
              <label htmlFor="preferred_route" className="block text-sm font-semibold text-gray-700 mb-2">
