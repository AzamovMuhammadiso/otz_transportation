...
import { MapPin, Package, Scale, User, Phone, Mail, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      <section className="relative h-[400px] bg-gradient-to-br from-blue-900 to-blue-700 text-white">
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/4393021/pexels-photo-4393021.jpeg?auto=compress&cs=tinysrgb&w=1920')] bg-cover bg-center opacity-20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Get a Quote</h1>
            <p className="text-xl text-blue-100 leading-relaxed">
              Request a free shipping quote and let us handle your freight transportation needs
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose OTZ Transportation?</h2>
              <p className="text-gray-700 mb-8 leading-relaxed">
                With over 14 years of experience and a fleet of 250+ modern trucks, we provide reliable,
                cost-effective freight solutions tailored to your business needs. Our commitment to on-time
              ...
              <div className="bg-gradient-to-br from-blue-50 to-orange-50 p-8 rounded-2xl">
                ...
                <p className="text-gray-700 mb-6">
                  Our logistics experts are available 24/7 to assist with your shipping needs and answer
                  any questions.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <Phone className="h-5 w-5 text-blue-900" />
                    <a href="tel:+18005551234" className="text-blue-900 font-semibold hover:text-blue-700">
                      1-800-555-1234
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <Mail className="h-5 w-5 text-blue-900" />
                    <a href="mailto:quotes@otztrans.com" className="text-blue-900 font-semibold hover:text-blue-700">
                      quotes@otztrans.com
                    </a>
                  </div>
                </div>
            ...
            <div>
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-green-900">Quote Request Submitted!</h3>
                    <p className="text-green-700 text-sm">
                      Thank you for your request. Our team will review your information and send you a detailed
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg space-y-6">
                ...
                <div>
                  <label htmlFor="load_type" className="block text-sm font-semibold text-gray-700 mb-2">
                ...
                <p className="text-sm text-gray-600 text-center">
                  By submitting this form, you agree to receive communications from OTZ Transportation.
                </p>
              </form>
            </div>
          </div>
