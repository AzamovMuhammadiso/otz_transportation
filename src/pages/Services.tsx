...
import trucks1 from "../assets/images/drivers.png";
import trucks2 from "../assets/images/truckimg5.png";
import trucks3 from "../assets/images/driver2.png";
import trucks4 from "../assets/images/truckexpreince.png";
  ...
  const services = [
    {
      ...
      description:
        "Dedicated transportation for large shipments that require an entire truck.",
      features: [
    ...
    },
    {
      ...
      description:
        "Cost-effective solution for smaller freight shipments that don't require a full truck.",
      features: [
    ...
    },
    {
      ...
      description:
        "Temperature-controlled transportation for perishable and temperature-sensitive goods.",
      features: [
    ...
    },
    {
      ...
      description:
        "Standard enclosed trailer transportation for general freight and non-perishable goods.",
      features: [
    ...
    },
    {
      ...
      description:
        "Fast, time-critical shipping when every minute counts for your business.",
      features: [
    ...
    <div className="min-h-screen">
      <Reveal>
        <section className="relative h-[400px] bg-gradient-to-br from-blue-900 to-blue-700 text-white">
          <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/27099095/pexels-photo-27099095.jpeg')] bg-cover bg-[position:50%_70%] opacity-20"></div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Comprehensive freight transportation solutions tailored to your
                business needs
              </p>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                We offer a range of value-added services to meet all your
                logistics needs
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Contact us today to discuss your freight transportation needs and
              get a custom quote
            </p>
