...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: 'info@otztrans.com',
      subdetails: 'We reply within 24 hours',
      link: 'mailto:info@otztrans.com',
    },
    {
      icon: MapPin,
      title: 'Address',
      ...
      link: 'https://maps.google.com/?q=123+Logistics+Way+Chicago+IL',
    },
    {
      icon: Clock,
      title: 'Office Hours',
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 mb-8 leading-relaxed">
                Have a question about our services? Need assistance with an existing shipment? Fill out
            ...
            <div>
              ...
              <div className="bg-gray-200 rounded-2xl overflow-hidden h-[500px]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2970.3168467799473!2d-87.6297981!3d41.8781136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2c3cd0f4cbed%3A0xafe0a6ad09c0c000!2sChicago%2C%20IL!5e0!3m2!1sen!2sus!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="mt-8 bg-gradient-to-br from-blue-50 to-orange-50 p-8 rounded-2xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  We understand the importance of timely communication in logistics. Our dedicated support
                  team monitors all inquiries and aims to respond within 2 hours during business hours and
